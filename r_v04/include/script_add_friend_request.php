...
<?php
    ...
    $sql = "INSERT INTO friend_request (currentUser, friend_request_name, current_request, completed_requests)
                    VALUES ('$friend_request_name', '$currentUser', 1, 0)";
              
        
                if ($conn->query($sql) === TRUE) {
                   header("location: ../user_profile.php?usrName=$friend_request_name&request=sent");
                 } 
                else {
